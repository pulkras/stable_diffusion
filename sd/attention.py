...
class SelfAttention(nn.Module):
    def __init__(self, n_heads: int, d_embed: int, in_proj_bias = True, out_proj_bias=True): # embed = embedding in_proj_bias = in projection bias
        super().__init__()
    ...
    def forward(self, x:torch.Tensor, causal_mask=False):
        ...
        interm_shape = (batch_size, sequence_length, self.n_heads, self.d_head) # intermideate shape
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # y (context) (Batch_Size, Seq_Len_Q, Dim_KV) = (Batch_Size, 77, 768)
