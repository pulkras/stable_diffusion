...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x, context):
        ...
        # normalization + self attention width skip connection
        residue_short = x
        ...
        # normalization + FF with geglu skip connection
        ...
        # (Batch_Size, Width * Height, Channels) -> (Batch_Size, Channels, Height*Width)
        x = x.transpose(-1, -2)
